            ...
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <p className="p service__text p__color">
                  Strong programming skills in Java, Objective – C, C#, and Swift
                </p>
                <p className="p service__text p__color">
                  Possess experience with API’s and third-party libraries and be familiar with OOP design principles
                </p>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <p className="p service__text p__color">
                  Responsible for debugging and repairing coding issues for client websites.
                </p>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <p className="p service__text p__color">
                  Created SEO friendly websites and leveraged user experience.
                </p>
                <p className="p service__text p__color">
